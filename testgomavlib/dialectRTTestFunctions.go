...
var schemasTest = []string{
	"{\"$id\":\"/mavlink/topic\",\"$schema\":\"https://json-schema.org/draft-07/schema#\",\"properties\":{\"acc_x\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"acc_y\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"acc_z\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"command\":{\"items\":{\"type\":\"integer\"},\"type\":\"array\"},\"pos_x\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"pos_y\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"pos_yaw\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"pos_z\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"time_usec\":{\"type\":\"integer\"},\"valid_points\":{\"type\":\"integer\"},\"vel_x\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"vel_y\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"vel_yaw\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"vel_z\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"}},\"type\":\"object\"}",
	"{\"$id\":\"/mavlink/topic\",\"$schema\":\"https://json-schema.org/draft-07/schema#\",\"properties\":{\"flow_comp_m_x\":{\"type\":\"number\"},\"flow_comp_m_y\":{\"type\":\"number\"},\"flow_rate_x\":{\"type\":\"number\"},\"flow_rate_y\":{\"type\":\"number\"},\"flow_x\":{\"type\":\"integer\"},\"flow_y\":{\"type\":\"integer\"},\"ground_distance\":{\"type\":\"number\"},\"quality\":{\"type\":\"integer\"},\"sensor_id\":{\"type\":\"integer\"},\"time_usec\":{\"type\":\"integer\"}},\"type\":\"object\"}",
	"{\"$id\":\"/mavlink/topic\",\"$schema\":\"https://json-schema.org/draft-07/schema#\",\"properties\":{\"covariance\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"pitchspeed\":{\"type\":\"number\"},\"q\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"rollspeed\":{\"type\":\"number\"},\"time_usec\":{\"type\":\"integer\"},\"yawspeed\":{\"type\":\"number\"}},\"type\":\"object\"}",
	"{\"$id\":\"/mavlink/topic\",\"$schema\":\"https://json-schema.org/draft-07/schema#\",\"properties\":{\"airspeed\":{\"type\":\"number\"},\"alt\":{\"type\":\"number\"},\"climb\":{\"type\":\"number\"},\"groundspeed\":{\"type\":\"number\"},\"heading\":{\"type\":\"integer\"},\"throttle\":{\"type\":\"integer\"}},\"type\":\"object\"}",
	"{\"$id\":\"/mavlink/topic\",\"$schema\":\"https://json-schema.org/draft-07/schema#\",\"properties\":{\"hw_unique_id\":{\"type\":\"string\"},\"hw_version_major\":{\"type\":\"integer\"},\"hw_version_minor\":{\"type\":\"integer\"},\"name\":{\"type\":\"string\"},\"sw_vcs_commit\":{\"type\":\"integer\"},\"sw_version_major\":{\"type\":\"integer\"},\"sw_version_minor\":{\"type\":\"integer\"},\"time_usec\":{\"type\":\"integer\"},\"uptime_sec\":{\"type\":\"integer\"}},\"type\":\"object\"}",
	"{\"$id\":\"/mavlink/topic\",\"$schema\":\"https://json-schema.org/draft-07/schema#\",\"properties\":{\"param_id\":{\"type\":\"string\"},\"param_index\":{\"type\":\"integer\"},\"target_component\":{\"type\":\"integer\"},\"target_system\":{\"type\":\"integer\"}},\"type\":\"object\"}",
	"{\"$id\":\"/mavlink/topic\",\"$schema\":\"https://json-schema.org/draft-07/schema#\",\"properties\":{\"angle_offset\":{\"type\":\"number\"},\"distances\":{\"items\":{\"type\":\"integer\"},\"type\":\"array\"},\"frame\":{\"type\":\"integer\"},\"increment\":{\"type\":\"integer\"},\"increment_f\":{\"type\":\"number\"},\"max_distance\":{\"type\":\"integer\"},\"min_distance\":{\"type\":\"integer\"},\"sensor_type\":{\"type\":\"integer\"},\"time_usec\":{\"type\":\"integer\"}},\"type\":\"object\"}",
	"{\"$id\":\"/mavlink/topic\",\"$schema\":\"https://json-schema.org/draft-07/schema#\",\"properties\":{\"angle_off\":{\"type\":\"number\"},\"distances\":{\"items\":{\"type\":\"integer\"},\"type\":\"array\"},\"frame\":{\"type\":\"integer\"},\"increment\":{\"type\":\"integer\"},\"increment_f\":{\"type\":\"number\"},\"max_distance\":{\"type\":\"integer\"},\"min_distance\":{\"type\":\"integer\"},\"sensor_type\":{\"type\":\"integer\"},\"time_usec\":{\"type\":\"integer\"}},\"type\":\"object\"}",
	"{\"$id\":\"/mavlink/topic\",\"$schema\":\"https://json-schema.org/draft-07/schema#\",\"properties\":{\"angle_offset\":{\"type\":\"number\"},\"distances\":{\"items\":{\"type\":\"integer\"},\"type\":\"array\"},\"frame\":{\"type\":\"integer\"},\"increment\":{\"type\":\"integer\"},\"increment_f\":{\"type\":\"number\"},\"max_distance\":{\"type\":\"integer\"},\"min_distance\":{\"type\":\"integer\"},\"sensor_type\":{\"type\":\"integer\"},\"time_usec\":{\"type\":\"integer\"}},\"type\":\"object\"}",
	"{\"$id\":\"/mavlink/topic\",\"$schema\":\"https://json-schema.org/draft-07/schema#\",\"properties\":{\"count\":{\"type\":\"integer\"},\"distance\":{\"items\":{\"type\":\"number\"},\"type\":\"array\"},\"time_usec\":{\"type\":\"integer\"}},\"type\":\"object\"}",
}
var jsonTest = []string{
