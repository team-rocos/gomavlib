...
func (m *MessageAqTelemetryF) GetId() uint32 {
    return 150
}

func (m *MessageAqTelemetryF) SetField(field string, value interface{}) error {
	return gomavlib.SetMessageField(m, field, value)
}
...
func (m *MessageAqEscTelemetry) GetId() uint32 {
    return 152
}

func (m *MessageAqEscTelemetry) SetField(field string, value interface{}) error {
	return gomavlib.SetMessageField(m, field, value)
}
