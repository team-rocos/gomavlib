...
func (m *MessageNavFilterBias) GetId() uint32 {
    return 220
}

func (m *MessageNavFilterBias) SetField(field string, value interface{}) error {
	return gomavlib.SetMessageField(m, field, value)
}
...
func (m *MessageRadioCalibration) GetId() uint32 {
    return 221
}

func (m *MessageRadioCalibration) SetField(field string, value interface{}) error {
	return gomavlib.SetMessageField(m, field, value)
}
...
func (m *MessageUalbertaSysStatus) GetId() uint32 {
    return 222
}

func (m *MessageUalbertaSysStatus) SetField(field string, value interface{}) error {
	return gomavlib.SetMessageField(m, field, value)
}
